...
function googleMapAPIScript() {
	...
	wp_register_script('blackbay_js_googlemaps_script', 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDaoJHIfiCoCLbOPVV_aK-uFXmta91ZBiU', array('jquery'), null);
